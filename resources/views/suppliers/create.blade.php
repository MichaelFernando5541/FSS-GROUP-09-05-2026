        ...
        <div class="max-w-2xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg p-6">
                ...
                <form action="{{ route('suppliers.store') }}" method="POST">
                    ...
                    <div class="mb-4">
                        <label class="block text-gray-700 font-bold mb-2">Nama Supplier / PT</label>
                    ...
                    <div class="flex justify-end">
                        ...
                        <button type="submit" class="bg-blue-600 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded">Simpan Supplier</button>
                    </div>
                </form>
